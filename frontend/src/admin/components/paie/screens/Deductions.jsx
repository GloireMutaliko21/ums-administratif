...
import { deductionsOptions } from '../../../data/SelectData';
...
const Deductions = () => {
    ...
    const beneficiaire = JSON.parse(localStorage.getItem('newDeduction'));
                    ...
                    <div className='shadow p-4 border-t-4 border-sky-500 rounded-t-lg'>
                        ...
                        <div className='w-full flex justify-end mt-4'>
                            <ReactToPrint
                                ...
                                onAfterPrint={() => {
                                    localStorage.removeItem('newDeduction');
                                }}
                            />
                        </div>
                    </div>
